  ...
  return (
    ...
    >
      ...
      <h1 className="mb-10 mt-4 px-4 text-2xl sm:text-4xl">
        <span className="font-medium !leading-[1.5] ">I'm a software developer with a passion for building scalable and efficient systems.</span>{" "}
        <p className="text-[14px]">
        Creating a well-structured portfolio is essentail for showcasing your skills, experience, and projects effectively.
        </p>
      </h1>
      </Fade>
      ...
      >
        ...
        <a
          ...
          href="https://www.linkedin.com/in/unique-day/"
          target="_blank"
        >
          <BsLinkedin />
        </a>
        ...
        <a
          ...
          href="https://github.com/Space-Xcode"
          target="_blank"
        >
          <FaGithubSquare />
        </a>
